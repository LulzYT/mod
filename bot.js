...
bot.on(`message`, function(msg) {
  ...
  if(command === config.command) {
	...
	.addField(':gear: Admin Commands :gear:', config.prefix+"__purge__ - Delete ammount of messages\n"+config.prefix+"__announce___ - Announce a message\n"+config.prefix+"__tempmute__ - Mute user for an ammount of time")
